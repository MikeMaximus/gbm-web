            ...
            <div id="leftcontent">
              ...
              <div class="pageSection">
                ...
                <div class="pageSectionContent">
                  ...
                  <h3 class="notop">Updated: November 13, 2016 (266 Configs)</h3>                  
                  <p class="small">Official backup configurations exclude graphics settings, logs, screenshots and other extras when possible.</p>
				  <p class="small">Official backup configurations may exclude autosaves and/or quicksaves when they massively increase backup size.</p>
